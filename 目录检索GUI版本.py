...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.selectButton.setGeometry(QtCore.QRect(20, 10, 75, 25))
        self.selectButton.setObjectName("selectButton")
        self.listExistFile = QtWidgets.QListWidget(self.centralwidget)
        self.listExistFile.setGeometry(QtCore.QRect(20, 130, 591, 281))
        self.listExistFile.setObjectName("listExistFile")
        self.exportButton = QtWidgets.QPushButton(self.centralwidget)
        self.exportButton.setGeometry(QtCore.QRect(20, 50, 75, 25))
        self.exportButton.setObjectName("exportButton")
        self.selectPath = QtWidgets.QTextEdit(self.centralwidget)
        self.selectPath.setGeometry(QtCore.QRect(110, 10, 501, 25))
        ...
        self.exportPath.setGeometry(QtCore.QRect(110, 50, 501, 25))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.selectButton.setText(_translate("MainWindow", "选择目录"))
        self.exportButton.setText(_translate("MainWindow", "保存路径"))
        self.pushButton.setText(_translate("MainWindow", "开始检索"))
    ...
    def exportFile(self):
        try:
            if os.path.isdir(self.selectPath.toPlainText()) and os.path.isdir(self.exportPath.toPlainText()):
                with open(self.exportPath.toPlainText() + '\\检索结果.csv', 'w', newline='') as f:
